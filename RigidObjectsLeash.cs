...
public class RigidObjectsLeash : VerletConstraint {
  public VerletObject objOne;
  public VerletObject objTwo;
  public float leashDistance;

  public RigidObjectsLeash(VerletObject objOne, VerletObject objTwo, float leashDistance) {
    this.objOne = objOne;
    this.objTwo = objTwo;
  ...
  public override void Constrain(List<VerletObject> objects, float dt) {
    ...
    if(distBetween != leashDistance && distBetween != 0) {
